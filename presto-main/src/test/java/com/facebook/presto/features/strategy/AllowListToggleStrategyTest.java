...
public class AllowListToggleStrategyTest
{
    ...
    public void prepare()
    {
        ...
        featureToggleConfig.setConfigSourceType(TestConfigurationSource.NAME);
    ...
    public void testAllowListStrategy()
    {
        ...
        config.put(FUNCTION_INJECTION_WITH_STRATEGY_FEATURE_ID, FeatureConfiguration.builder().featureToggleStrategyConfig(featureToggleStrategyConfig).build());
        sleep();
