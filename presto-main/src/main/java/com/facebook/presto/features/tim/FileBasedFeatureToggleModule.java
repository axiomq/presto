...
import com.facebook.presto.features.config.AllowListToggleStrategy;
...
import com.facebook.presto.features.config.FeatureToggleStrategy;
import com.facebook.presto.features.config.FeatureToggleStrategyFactory;
import com.facebook.presto.features.config.FileBasedFeatureToggle;
import com.facebook.presto.features.config.ForwardingFeatureToggle;
import com.facebook.presto.features.config.OsToggleStrategy;
        ...
        extends AbstractConfigurationAwareModule
{
    ...
    @Inject
    @Provides
    public FeatureToggle getFeatureToggleConfiguration(FeatureToggleConfig config, FeatureToggleStrategyFactory featureToggleStrategyFactory)
    {
