        ...
        if (configuration != null) {
            ...
            if (configuration.getFeatureToggleStrategyConfig().isPresent()) {
                ...
                if (toggleStrategyClass != null) {
                    ...
                    return strategy
                            .map(featureToggleStrategy -> enabled.get() && featureToggleStrategy.check(configuration, featureId))
                            .orElse(enabled.get());
                }
            }
        }
        ...
        if (configuration != null) {
            ...
            if (configuration.getFeatureToggleStrategyConfig().isPresent()) {
                ...
                if (toggleStrategyClass != null) {
                    Optional<FeatureToggleStrategy> strategy = Optional.ofNullable(featureToggleStrategyFactory.get(toggleStrategyClass));
                    return strategy
                            .map(featureToggleStrategy -> enabled.get() && featureToggleStrategy.check(configuration, featureId, object))
                            .orElse(enabled.get());
                }
            }
        }
